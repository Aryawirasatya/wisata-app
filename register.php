...
if (isset($_POST['submit_user'])) {
    // Memanggil fungsi tambah_user dan mengirimkan data
            ...
            <div class="col-md-6 col-lg-5">
                <div class="card p-4">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Isi formulir untuk membuat akun</p>
                    </div>
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kontak" name="kontak" placeholder="Masukkan nomor telepon">
                        </div>
                        <button type="submit" name="submit_user" class="btn btn-primary w-100">Buat Akun</button>
                    </form>
